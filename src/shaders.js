...
void main() {
    ...
    // Debugging: Visualize mouse position
    float distanceFromMouse = distance(uv, mousePos);
    if(distanceFromMouse < 0.1) { // Adjust the threshold as needed
      gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); // Red where the mouse is close
    } else {
